...
- Apply updated repository structure & CI workflow 
- Merge pull request #6 from barisozdag/dependabot/github_actions/brpaz/hadolint-action-v1.4.0
...
- Merge pull request #5 from barisozdag/dependabot/github_actions/actions/cache-v2.1.5
...
- Merge pull request #3 from barisozdag/dependabot/github_actions/docker/setup-buildx-action-v1.1.2
...
Signed-off-by: dependabot[bot] <support@github.com> 
- Merge pull request #2 from barisozdag/dependabot/github_actions/docker/build-push-action-v2.4.0
