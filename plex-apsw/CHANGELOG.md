...
- Merge pull request #38 from barisozdag/dependabot/github_actions/frenck/action-addon-linter-2.2

⬆️ Bump frenck/action-addon-linter from 2.1 to 2.2 
- Merge pull request #37 from barisozdag/dependabot/github_actions/docker/setup-buildx-action-1.5.1

⬆️ Bump docker/setup-buildx-action from 1.5.0 to 1.5.1 
- Merge pull request #36 from barisozdag/dependabot/github_actions/dessant/lock-threads-2.1.1

⬆️ Bump dessant/lock-threads from 2.0.3 to 2.1.1 
...
Signed-off-by: dependabot[bot] <support@github.com> 
- Merge pull request #35 from barisozdag/dependabot/github_actions/docker/setup-buildx-action-1.5.0

⬆️ Bump docker/setup-buildx-action from 1.4.1 to 1.5.0 
