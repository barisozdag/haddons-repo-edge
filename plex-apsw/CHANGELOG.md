...
- Merge pull request #17 from barisozdag/dependabot/github_actions/brpaz/hadolint-action-v1.5.0 
...
Signed-off-by: dependabot[bot] <support@github.com> 
- Merge pull request #16 from barisozdag/dependabot/github_actions/docker/setup-buildx-action-v1.3.0
...
Signed-off-by: dependabot[bot] <support@github.com> 
- Merge pull request #15 from barisozdag/dependabot/github_actions/docker/login-action-v1.9.0
...
Signed-off-by: dependabot[bot] <support@github.com> 
- Merge pull request #13 from barisozdag/dependabot/github_actions/docker/setup-buildx-action-v1.2.0

Bump docker/setup-buildx-action from v1.1.2 to v1.2.0 
- Merge pull request #14 from barisozdag/dependabot/github_actions/docker/setup-qemu-action-v1.1.0
